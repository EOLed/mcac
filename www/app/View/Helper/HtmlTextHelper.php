...
class HtmlTextHelper extends AppHelper {
    ...
    function convert_html_to_text($html) {
        CakeLog::write("debug", "converting html... $html");
        $html = $this->fix_newlines("<html><head><title>hi</title></head><body>$html</body></html>");
        CakeLog::write("debug", "fixed newlines... $html");
        $doc = new DOMDocument();
        CakeLog::write("debug", "instantiated dom document");
        if (!$doc->loadHTML($html)) {
            CakeLog::write("error", "Could not load HTML - badly formed? $html");
            return false;
        }

        CakeLog::write("debug", "DOM document loaded");
        ...
        CakeLog::write("debug", "converted text: $output");
